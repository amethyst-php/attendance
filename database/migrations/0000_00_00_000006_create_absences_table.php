...
class CreateAbsencesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create(Config::get('amethyst.attendance.data.absence.table'), function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists(Config::get('amethyst.attendance.data.absence.table'));
    }
}
